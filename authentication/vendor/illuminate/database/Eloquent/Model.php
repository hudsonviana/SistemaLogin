...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    const CREATED_AT = 'criado_em'; //este campo foi alterado para conincidir com o nome da coluna no banco de dados
    ...
    const UPDATED_AT = 'atualizado_em'; //este campo foi alterado para conincidir com o nome da coluna no banco de dados
